...
This WordPress plugin provides a shortcode to display a customized Google Map. It includes a settings page to securely store your Google Maps API key and allows you to switch between different map modes.
